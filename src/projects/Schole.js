    ...
    return (
      <section className="project-content schole">
        ...
        <div className="summary">
          ...
          <div className="content white end">
        ...
        <div className="background">
          <div className="content-title">Job Training through Real Project Documents</div>
        ...
        <div className="problem">
          <div className="content-title middle">Reluctancies with Supplying Confidential Content</div>
