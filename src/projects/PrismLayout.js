    ...
    return (
      <section className="project-content prismlayout">
        ...
        <div className="summary">
          ...
          <div className="content end white">In this project, I redesigned the core layout of the app to better scale for future implementations. I defined the problem space, created high fidelity concept prototypes, developed the concepts and implemented them. Throughout the process, I was careful to balance the usability, business goals and technical constraints, and the end result was proved cohesive through the feedback of many users.</div>
        </div>
        <div className="background">
          <div className="content-title">PRISM Live Studio PC,<br/>The Live Broadcasting Software for Beginners</div>
        ...
        <div className="effects">
          <div className="content-title">Exploring Different Placements of the Effects Panel</div>
        ...
        <div className="solution">
          <div className="content-title">The Final Solution</div>
